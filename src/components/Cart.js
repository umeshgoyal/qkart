    ...
    return (
      ...
      >
              ...
              <Card className="cart-item" key={item.productId}>
                ...
                <div className="cart-parent">
                  ...
                  <div className="cart-item-qty">
                    ...
                    {this.props.checkout ? (<div className="cart-item-qty-fixed">Qty: 
                    <InputNumber min={1} max={10} style= {{width:45}} defaultValue={item.qty} bordered={false} readOnly={true}/>
                    </div>):(
                      this.getQuantityElement(item)
                    )}
                  </div>
        ...
        {/* TODO: CRIO_TASK_MODULE_CART - If props.checkout is not set, display a checkout button*/}
          {!this.props.checkout &&  (
             <Button type="primary"  prefix={<ShoppingCartOutlined />} onClick={()=>{
              this.state.items.length ? this.props.history.push('/checkout') : 
